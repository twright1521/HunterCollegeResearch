%% Fourier Transforms - White Noise - De-Trended
    ...
    for fol_idx = 1:length(File_Fol)
        for model_idx = 1:length(Model_Fol)
            ...
            if (save_tag == 1)
                ...
                save_folder = strcat(save_folder,filesep,'De_Trended_Fourier_Transform_White_Noise');
                if (exist(save_folder,'dir') == 0)
                    mkdir(save_folder)
                end   
            ...
            if (save_tag == 1)
                ...
                save_PNG_folder = strcat(save_PNG_folder,filesep,'De_Trended_Fourier_Transform_White_Noise');
                if (exist(save_PNG_folder,'dir') == 0)
                    mkdir(save_PNG_folder)
                end
