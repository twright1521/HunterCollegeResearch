...
File_Fol = {'','5.1_cccma_canesm2_tasmax_output','7.1_ncar_ccsm4_tasmax_output',...
            '21.2_HadGEM2-CC_tasmax_output'};     

% File Name - must contain "Annual, "Seasonal", or "10yr"
file_name = {'catskill_compare_stations_june2017_TMAX_combined_Annual_Mean',...
             'tasmax_day_CCSM4_historical_r1i1p1_Annual_Mean',...
             'tasmax_day_CCSM4_historical_r2i1p1_Annual_Mean',...
             'tasmax_day_CCSM4_historical_r6i1p1_Annual_Mean',...
             'tasmax_day_HadGEM2-CC_historical_r1i1p1_Annual_Mean',...
             'tasmax_day_HadGEM2-CC_historical_r2i1p1_Annual_Mean',...
             'tasmax_day_HadGEM2-CC_historical_r3i1p1_Annual_Mean',...
             'tasmax_day_CanESM2_historical_r1i1p1_Annual_Mean',...
             'tasmax_day_CanESM2_historical_r2i1p1_Annual_Mean',...
             'tasmax_day_CanESM2_historical_r3i1p1_Annual_Mean',...
             'tasmax_day_CanESM2_historical_r4i1p1_Annual_Mean',...
             'tasmax_day_CanESM2_historical_r5i1p1_Annual_Mean'};
    ...
    for fol_idx = 1:length(File_Fol)
        for model_idx = 1:length(Model_Fol)
            ...
            if (save_tag == 1)
                ...
                save_folder = strcat(save_folder,filesep,'Fourier_Transform_Red_Noise');
                if (exist(save_folder,'dir') == 0)
                    mkdir(save_folder)
                end   
            ...
            if (save_tag == 1)
                ...
                save_PNG_folder = strcat(save_PNG_folder,filesep,'Fourier_Transform_Red_Noise');
                if (exist(save_PNG_folder,'dir') == 0)
                    mkdir(save_PNG_folder)
                end
